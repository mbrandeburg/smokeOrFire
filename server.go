...
func main() {
	...
	log.Println("🔥 Smoke or Fire web server starting...")
	log.Println("🎮 Game available at: http://localhost:8343")
...
func createGame(c *gin.Context) {
	...
	newGame, err := game.NewGame(gameID, req.PlayerCount, req.DeckCount, req.PlayerNames)
	if err != nil {
		c.JSON(http.StatusBadRequest, gin.H{"error": err.Error()})
		return
	}
